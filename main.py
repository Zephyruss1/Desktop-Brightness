...
class DesktopBrightnessApp:
    ...
    def __init__(self):
        ...
        self.img = PIL.Image.open(
            r'C:\Users\ekber\OneDrive\Desktop\Python_simple_projects\Desktop_brightness_app\icon.ico')
        self.root.iconbitmap(r'C:\Users\ekber\OneDrive\Desktop\Python_simple_projects\Desktop_brightness_app\icon.ico')
